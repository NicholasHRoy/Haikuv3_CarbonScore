...
$if not set UI_Yrs        $setglobal UI_Yrs        13CSP !! number and version of years in initial variable values
...
$setglobal UI_Scen      %UI_Yrs%_%UI_ScenKnl%_%UI_vInputs%_v3  !! name the scenario
